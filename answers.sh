...
# Task 7
cp -r Programs/Java Homework/CS180 && mv Homework/CS180/Java Homework/CS180/Project_1
...
set titlecolor black,blue    # COLOR_1 is the text, COLOR_2 is the backgrou>
